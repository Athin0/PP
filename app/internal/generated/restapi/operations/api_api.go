...
func NewAPIAPI(spec *loads.Document) *APIAPI {
	return &APIAPI{
		...
		GetResultsHandler: GetResultsHandlerFunc(func(params GetResultsParams) middleware.Responder {
			return middleware.NotImplemented("operation GetResults has not yet been implemented")
		}),
		ProduceMessageHandler: ProduceMessageHandlerFunc(func(params ProduceMessageParams) middleware.Responder {
			return middleware.NotImplemented("operation ProduceMessage has not yet been implemented")
		}),
		SayHelloHandler: SayHelloHandlerFunc(func(params SayHelloParams) middleware.Responder {
			return middleware.NotImplemented("operation SayHello has not yet been implemented")
		}),
	}
}

/*APIAPI HTTP server in Go with Swagger endpoints definition */
type APIAPI struct {
	spec            *loads.Document
	...
	// ProduceMessageHandler sets the operation handler for the produce message operation
	ProduceMessageHandler ProduceMessageHandler
	// SayHelloHandler sets the operation handler for the say hello operation
...
func (o *APIAPI) Validate() error {
	...
	if o.GetResultsHandler == nil {
		unregistered = append(unregistered, "GetResultsHandler")
	}
	if o.ProduceMessageHandler == nil {
		unregistered = append(unregistered, "ProduceMessageHandler")
	}
	if o.SayHelloHandler == nil {
		unregistered = append(unregistered, "SayHelloHandler")
	}
...
func (o *APIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/health/check"] = NewCheckHealth(o.context, o.CheckHealthHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/get/results"] = NewGetResults(o.context, o.GetResultsHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/produce"] = NewProduceMessage(o.context, o.ProduceMessageHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/hello/{user}"] = NewSayHello(o.context, o.SayHelloHandler)
}
