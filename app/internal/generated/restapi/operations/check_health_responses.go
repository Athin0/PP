...
type CheckHealthOK struct {
	...
	/*
	  In: Body
	*/
	Payload *CheckHealthOKBody `json:"body,omitempty"`
}
...
func (o *CheckHealthOK) WithPayload(payload *CheckHealthOKBody) *CheckHealthOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the check health o k response
func (o *CheckHealthOK) SetPayload(payload *CheckHealthOKBody) {
	o.Payload = payload
}
